...
% data is a cell matrix of MxL where in each element there is an array of N
...
% Plot it
emptyGrp = setdiff([1:length(positions)], group);
ngrp = length(emptyGrp);
x = [x;zeros(ngrp,1)];
group = [group;emptyGrp'];
